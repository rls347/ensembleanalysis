...
def coloredplot(modeldirs,var,height,nameout,rh):
    ...
    ax.set_ylim(0,20)
    ax.autoscale()
    plt.savefig('/nobackup/rstorer/plots/avgprof-'+nameout+'-sortedbyrhlow.png')
    plt.close()
...
#np.savez('../filesnpz/revuprofile-flux-netvertical.npz',**allflux)
#np.savez('../filesnpz/revuprofile-flux-precip.npz',**allprecip)
#np.savez('../filesnpz/revuprofile-flux-updraft.npz',**allupdraft)
...
allvapor = np.load('../filesnpz/revuprofile-flux-updraft-vapor.npz')
...
plt.savefig(outdir+'/fluxprofs-revu-maxwgt5-allruns-updraft-vapandcond.png')
plt.clf()
...
plt.savefig(outdir+'/fluxprofs-revu-maxwgt5-allruns-precip.png')
plt.clf()
...
plt.savefig(outdir+'/fluxprofs-revu-maxwgt5-allruns-netvertical-vapandcond.png')
plt.clf()
