...
testw = getvar('/nobackup/rstorer/convperts/mature/aug11-control/aug11-control-mature-017.h5','w')
print testw.max(), np.unravel_index(testw.argmax(),testw.shape)

testw = getvar('/nobackup/rstorer/convperts/mature/aug17-control/aug17-control-mature-007.h5','w')
print testw.max(), np.unravel_index(testw.argmax(),testw.shape)

testw = getvar('/nobackup/rstorer/convperts/mature/feb23-control/feb23-control-mature-007.h5','w')
print testw.max(), np.unravel_index(testw.argmax(),testw.shape)


w11 = smoothedvar(getvar('/nobackup/rstorer/convperts/mature/aug11-control/aug11-control-mature-017.h5','w'), 171)
w17 = smoothedvar(getvar('/nobackup/rstorer/convperts/mature/aug17-control/aug17-control-mature-007.h5','w'), 158)
w23 = smoothedvar(getvar('/nobackup/rstorer/convperts/mature/feb23-control/feb23-control-mature-007.h5','w'), 172)
cond11 = smoothedvar(getvar('/nobackup/rstorer/convperts/mature/aug11-control/aug11-control-mature-017.h5','total_cond'), 171)
cond17 = smoothedvar(getvar('/nobackup/rstorer/convperts/mature/aug17-control/aug17-control-mature-007.h5','total_cond'), 158)
cond23 = smoothedvar(getvar('/nobackup/rstorer/convperts/mature/feb23-control/feb23-control-mature-007.h5','total_cond'), 172)
q11 = smoothedvar(getvar('/nobackup/rstorer/convperts/mature/quickbeam/aug11-control-mature-017-quickbeam.h5','reflectivity'), 171)
q17 = smoothedvar(getvar('/nobackup/rstorer/convperts/mature/quickbeam/aug17-control-mature-007-quickbeam.h5','reflectivity'), 158)
q23 = smoothedvar(getvar('/nobackup/rstorer/convperts/mature/quickbeam/feb23-control-mature-007-quickbeam.h5','reflectivity'), 172)
q112 = smoothedvar(getvar('/nobackup/rstorer/convperts/mature/quickbeam/aug11-control-mature-020-quickbeam.h5','reflectivity'), 171)
q172 = smoothedvar(getvar('/nobackup/rstorer/convperts/mature/quickbeam/aug17-control-mature-010-quickbeam.h5','reflectivity'), 158)
q232 = smoothedvar(getvar('/nobackup/rstorer/convperts/mature/quickbeam/feb23-control-mature-010-quickbeam.h5','reflectivity'), 172)
...
z = getvar('/nobackup/rstorer/convperts/mature/feb23-control/feb23-control-mature-017.h5','z_coords')/1000.
#x = np.arange(400)*.25
#x = np.arange(20)*5
x = np.arange(33)*3
...
www11 = ww11#np.max(w11[height5km:,:],0)
www17 = ww17#np.max(w17[height5km:,:],0)
www23 = ww23#np.max(w23[height5km:,:],0)
...
ax1.plot(x,www23,linewidth=2,label ='Max W')
ax1.tick_params(labelleft='off')
ax1.set_yticklabels([])
ax1.set_ylim(0,15)
ax1.set_xlabel('km')
#plt.title('Max Updraft')
ax2 = ax1.twinx()
ax1.plot(x,md23,linestyle='dashed',color='black',linewidth=2,label = 'Max dBZ/min')
ax2.set_ylim(0,15)
ax2.set_ylabel('Max dBZ/min')
ax2.tick_params(labelleft='off')
handles, labels = ax1.get_legend_handles_labels()
ax1.set_zorder(1) 
ax1.legend(handles,labels,loc = 'upper left',prop={'size':10},bbox_to_anchor=(-0.55, .97))
...
#ax6 = fig.add_axes([.88,.1,.02,.2],frameon=False, xticks=[], yticks=[])
#ax6.legend(handles,labels,loc='center right',prop={'size': 10})

#fig.tight_layout()
#plt.suptitle('5km footprint, both ddBZ and w above 5km')
plt.savefig('../plots/radarfigure-3kmfootprint.png')
